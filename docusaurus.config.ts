...
const config: Config = {
  ...
  url: 'https://randellyaptuazon.github.io/',
  ...
  organizationName: 'randellyaptuazon', // Usually your GitHub org/user name.
  projectName: 'randellyaptuazon.github.io', // Usually your repo name.
