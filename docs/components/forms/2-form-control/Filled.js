    ...
    <FeatureBlock>
      <FeatureBlock.Body>
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="flex-1 md:w-full px-4">
            <div className="form-group mb-4">
              <input type="email" className="form-input form-input-filled form-input-lg" placeholder="name@example.com" />
              <label className="inline-block">Email address</label>
            </div>

            <div className="form-group mb-4">
              <input type="email" className="form-input form-input-filled" placeholder="name@example.com" />
              <label className="inline-block">Email address</label>
            </div>

            <div className="form-group mb-4">
              <input type="email" className="form-input form-input-filled form-input-sm" placeholder="name@example.com" />
